...
def gen_markup():
    ...
    dev = types.InlineKeyboardButton(text="T۰۪۫O۪۫۰۰۪۫F۪۫۰۰۪۫E۪۫۰۰۪۫Y۪۫۰", url="t.me/zzsszzz")
    markup.add(dev)
...
⚜️ ¦ يرجى ارسال اسم التطبيق للبحث عليه في هايبي مود
""") 
    else:
        pass
